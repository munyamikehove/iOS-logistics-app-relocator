                ...
                Button(action: {
                    ...
                    if viewRouter.OriginSelectorCounter != 0{
                        if viewRouter.DestinationSelectorCounter != 0{
                            if viewRouter.originAddress != "Move-out address here"{
                                if viewRouter.destinationAddress != "Move-in address here" {

                                    viewRouter.stepOneOrigin = "moving"
                                    ...
                                    viewRouter.inspectionDay = formatter.string(from: viewRouter.Moveday.addingTimeInterval(-7*24*60*60))
                ...
                VStack{
                    ...
                    HStack{
                        ...
                        if viewRouter.destinationAddress == "Move-in address here" {
                            ...
                            Text("\(viewRouter.destinationAddress)")
                                .foregroundColor(Color.gray)
                                .font(.system(size: 20))
                                .frame(minWidth: UIScreen.main.bounds.width-100,alignment: .leading)
                                .padding(EdgeInsets(top: 10, leading: 10, bottom: 10, trailing: 10))
